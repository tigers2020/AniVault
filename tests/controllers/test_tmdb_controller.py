...
class TestTMDBController:
    ...
    def tmdb_controller_with_api_key(self):
        ...
        return TMDBController(api_key="test_api_key")
    ...
    def test_tmdb_controller_initialization_with_api_key(self, tmdb_controller_with_api_key):
        """Test TMDBController initialization with API key."""
        assert tmdb_controller_with_api_key is not None
        assert tmdb_controller_with_api_key.api_key == "test_api_key"
    ...
    def test_match_files_already_matching(self, tmdb_controller_with_api_key, mock_scanned_file):
    ...
    def test_match_files_success(self, mock_thread_class, mock_worker_class,
                                tmdb_controller_with_api_key, mock_scanned_file):
    ...
    def test_get_matched_files_count(self, tmdb_controller):
        ...
        tmdb_controller.match_results = [
            {"file_path": "/test1.mkv", "match_result": {"title": "Anime 1"}, "status": "matched"},
            {"file_path": "/test2.mkv", "match_result": None, "status": "no_match"},
            {"file_path": "/test3.mkv", "match_result": {"title": "Anime 3"}, "status": "matched"},
        ]
    ...
    def test_signal_handler_methods(self, tmdb_controller):
        ...
        result = {"file_path": "/test.mkv", "file_name": "test.mkv", "status": "matched"}
