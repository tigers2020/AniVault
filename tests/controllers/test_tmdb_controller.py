...
class TestTMDBController:
    ...
    def test_tmdb_controller_initialization_with_api_key(
        ...
        assert (
            tmdb_controller_with_api_key.api_key == "test_api_key"
    ...
    def test_set_api_key(self, tmdb_controller):
        ...
        tmdb_controller.set_api_key("new_api_key")  # pragma: allowlist secret

        assert tmdb_controller.api_key == "new_api_key"  # pragma: allowlist secret
