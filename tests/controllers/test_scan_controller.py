...
class TestScanController:
    ...
    def test_scan_directory_success(self, mock_thread_class, mock_worker_class, 
                                   scan_controller, temp_directory):
    ...
    def test_group_files_success(self, mock_grouper_class, scan_controller, mock_file_item):
    ...
    def test_group_files_parser_error(self, mock_parser_class, scan_controller, mock_file_item):
