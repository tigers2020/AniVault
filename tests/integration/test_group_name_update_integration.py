...
class TestGroupNameUpdateIntegration:
    ...
    def test_end_to_end_group_name_update(self):
        ...
        with patch("anivault.core.file_grouper.AnitopyParser") as mock_parser_class:
            ...
            files = [
                ScannedFile(
                    ...
                    metadata=ParsingResult(
                        title="Attack on Titan - 01", parser_used="test"
                    ),
                    file_size=1000,
                ...
                ScannedFile(
                    ...
                    metadata=ParsingResult(
                        title="Attack on Titan - 02", parser_used="test"
                    ),
                    file_size=1000,
                    last_modified=1234567890.0,
                ),
                ScannedFile(
                    ...
                    metadata=ParsingResult(
                        title="One Piece - 1000", parser_used="test"
                    ),
                    file_size=1000,
                    last_modified=1234567890.0,
                ),
            ...
            assert (
                has_anime_title
            ), f"Expected anime titles in group names: {group_names}"
        ...
        with patch("anivault.core.file_grouper.AnitopyParser") as mock_parser_class:
            ...
            files = [
                ...
                ScannedFile(
                    ...
                    metadata=ParsingResult(
                        title="bad_filename_ep02", parser_used="test"
                    ),
                    file_size=1000,
                    last_modified=1234567890.0,
                ),
            ...
            assert (
                has_good_title or len(group_names) > 0
            )  # At least some grouping occurred
        ...
        with patch("anivault.core.file_grouper.AnitopyParser", side_effect=ImportError):
            ...
            files = [
                ScannedFile(
                    ...
                    metadata=ParsingResult(
                        title="anime_title_ep01", parser_used="test"
                    ),
                    file_size=1000,
                    last_modified=1234567890.0,
                ),
