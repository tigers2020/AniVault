...
class TestEnhancedOrganize:
    ...
    def test_generate_enhanced_organization_plan_single_file(self):
        ...
        with patch('anivault.core.file_grouper.FileGrouper') as mock_grouper, \
             patch('anivault.core.resolution_detector.ResolutionDetector') as mock_resolution, \
    ...
    def test_generate_enhanced_organization_plan_with_subtitles(self):
        ...
        with patch('anivault.core.file_grouper.FileGrouper') as mock_grouper, \
            ...
            mock_subtitle.return_value.find_matching_subtitles.return_value = [subtitle_file]
    ...
    def test_generate_enhanced_organization_plan_resolution_sorting(self):
        ...
        with patch('anivault.core.file_grouper.FileGrouper') as mock_grouper, \
            ...
            mock_resolution.return_value.find_highest_resolution.return_value = high_res_file
            mock_subtitle.return_value.find_matching_subtitles.return_value = []
            
            result = _generate_enhanced_organization_plan([high_res_file, low_res_file], args)
            assert len(result) == 2
    ...
    def test_generate_enhanced_organization_plan_korean_titles(self):
        ...
        with patch('anivault.cli.organize_handler.FileGrouper') as mock_grouper, \
             patch('anivault.cli.organize_handler.ResolutionDetector') as mock_resolution, \
             patch('anivault.cli.organize_handler.SubtitleMatcher') as mock_subtitle, \
             patch('anivault.services.metadata_enricher.MetadataEnricher') as mock_enricher:
