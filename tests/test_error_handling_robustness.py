...
class TestErrorHandlingRobustness:
    ...
    def test_invalid_file_paths(self, organizer, temp_directories):
        ...
        with pytest.raises(ValueError, match="scanned_file must have a valid file_path with name"):
    ...
    def test_invalid_operation_parameters(self, organizer, temp_directories):
        ...
        with pytest.raises((ValueError, TypeError)):
            organizer.generate_plan(None)

        with pytest.raises((ValueError, TypeError)):
            organizer.organize(None)
    ...
    def test_edge_case_file_sizes(self, organizer, temp_directories):
        ...
        with pytest.raises(ValueError, match="scanned_file.file_size must be non-negative"):
        ...
        assert organizer.file_count == len(edge_cases)
