...
class TestFileGrouperGroupNameUpdate:
    ...
    @pytest.mark.skip(
        reason="Mock conflicts with TitleExtractor parser initialization - infrastructure issue"
    )
    ...
    def test_ensure_unique_group_name_multiple_conflicts(self):
        ...
        existing_groups = {"Group A": [], "Group A (1)": [], "Group A (2)": []}
        new_name = "Group A"
    ...
    def test_update_group_names_with_parser_success(self, mock_parser_class):
        ...
        grouped_files = {"attack on titan": [file1]}
    ...
    @pytest.mark.skip(
        reason="Mock conflicts with multiple parser instances - infrastructure issue"
    )
    @patch("anivault.core.file_grouper.AnitopyParser")
    def test_update_group_names_with_parser_failure(self, mock_parser_class):
        ...
        grouped_files = {"test group": [file1]}
    ...
    def test_group_files_with_parser_update(self):
        ...
        with patch("anivault.core.file_grouper.AnitopyParser") as mock_parser_class:
            ...
            file1 = ScannedFile(
                ...
                metadata=ParsingResult(title="attack on titan ep1", parser_used="test"),
                file_size=1000,
            ...
            file2 = ScannedFile(
                ...
                metadata=ParsingResult(title="attack on titan ep2", parser_used="test"),
                file_size=1000,
                last_modified=1234567890.0,
            )
