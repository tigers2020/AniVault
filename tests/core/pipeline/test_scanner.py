...
class TestDirectoryScanner:
    ...
    def test_parallel_scan_directory_basic(self, temp_test_dir):
        ...
        video_files = [f for f in files if f.suffix in FileSystem.SUPPORTED_VIDEO_EXTENSIONS]
    ...
    def test_parallel_scan_directory_nonexistent(self):
        ...
        # When
        files, dirs_scanned = scanner._parallel_scan_directory(Path("/nonexistent/path"))
    ...
    def test_parallel_scan_directory_file_not_dir(self, temp_test_dir):
        ...
        # When
        files, dirs_scanned = scanner._parallel_scan_directory(temp_test_dir / "video1.mp4")
