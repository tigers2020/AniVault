...
class TestGroupCardWidget:
    ...
    def test_edit_group_name_callback(self, qapp, sample_files):
        ...
        # Verify parent method was called
        mock_parent.edit_group_name.assert_called_once_with("Test Group", sample_files)
...
class TestGroupGridViewWidget:
    ...
    def test_update_group_name_with_parser_success(self, qapp, sample_files):
        ...
        # Mock AnitopyParser
        with patch(
            "anivault.core.parser.anitopy_parser.AnitopyParser"
    ...
    @pytest.mark.skip(
        reason="Qt modal dialog blocks test execution - needs event loop fix"
    )
    def test_update_group_name_with_parser_no_parser(self, qapp, sample_files):
        ...
        # Mock ImportError
        with patch(
            "anivault.core.parser.anitopy_parser.AnitopyParser", side_effect=ImportError
        ):
