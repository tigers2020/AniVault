...
class TestPanelRefactoring:
    ...
    def test_work_panel_theme_integration(self, qapp):
    ...
    def test_log_panel_theme_integration(self, qapp):
    ...
    def test_anime_groups_panel_theme_integration(self, qapp):
    ...
    def test_theme_consistency_across_panels(self, qapp):
    ...
    def test_color_access_methods(self):
    ...
    def test_no_hardcoded_colors_in_panels(self, qapp):
