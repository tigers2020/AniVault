"""Simple tests for query normalizer."""

from anivault.services.query_normalizer import QueryNormalizer


class TestQueryNormalizerSimple:
    """Simple test cases for QueryNormalizer."""

    def test_normalize_query_cleaning(self):
        """Test query cleaning patterns."""
