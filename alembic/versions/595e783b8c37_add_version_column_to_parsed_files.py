...
down_revision: Union[str, Sequence[str], None] = '63b04737b492'
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_anime_metadata_first_air_date'), 'anime_metadata', ['first_air_date'], unique=False)
    op.create_index(op.f('ix_anime_metadata_korean_title'), 'anime_metadata', ['korean_title'], unique=False)
    op.create_index(op.f('ix_anime_metadata_original_title'), 'anime_metadata', ['original_title'], unique=False)
    op.create_index(op.f('ix_anime_metadata_popularity'), 'anime_metadata', ['popularity'], unique=False)
    ...
    op.create_index(op.f('ix_anime_metadata_vote_average'), 'anime_metadata', ['vote_average'], unique=False)
    ...
    op.create_index(op.f('ix_parsed_files_file_extension'), 'parsed_files', ['file_extension'], unique=False)
    ...
    op.create_index(op.f('ix_parsed_files_is_processed'), 'parsed_files', ['is_processed'], unique=False)
    op.create_index(op.f('ix_parsed_files_metadata_id'), 'parsed_files', ['metadata_id'], unique=False)
    op.create_index(op.f('ix_parsed_files_parsed_title'), 'parsed_files', ['parsed_title'], unique=False)
    op.create_index(op.f('ix_parsed_files_release_group'), 'parsed_files', ['release_group'], unique=False)
    op.create_index(op.f('ix_parsed_files_resolution'), 'parsed_files', ['resolution'], unique=False)
