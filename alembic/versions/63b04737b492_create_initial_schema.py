...
down_revision: str | Sequence[str] | None = "3ff80129897d"
...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_anime_metadata_korean_title", "anime_metadata", ["korean_title"], unique=False
    )
    op.create_index("idx_anime_metadata_status", "anime_metadata", ["status"], unique=False)
    op.create_index(
        "idx_anime_metadata_vote_average", "anime_metadata", ["vote_average"], unique=False
    )
    op.create_index(
        "idx_anime_metadata_first_air_date", "anime_metadata", ["first_air_date"], unique=False
    )
    ...
    op.create_index(
        "idx_parsed_files_season_episode", "parsed_files", ["season", "episode"], unique=False
    )
    op.create_index("idx_parsed_files_resolution", "parsed_files", ["resolution"], unique=False)
    op.create_index(
        "idx_parsed_files_release_group", "parsed_files", ["release_group"], unique=False
    )
