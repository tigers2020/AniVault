    ...
    def profile_streaming_scan(self) -> Dict[str, Any]:
        ...
        for entry in scan_directory(self.test_dir):
            ...
            if file_count % 1000 == 0:
                ...
                if memory_mb > 500:
                    print(
                        f"  ⚠️  Memory usage exceeded 500MB at {file_count} files: {memory_mb:.2f}MB"
                    )
                    break
    ...
    def print_results(self) -> None:
        ...
        for result in self.results:
            ...
            if result["peak_memory_used_mb"] > 500:
                print("  ⚠️  WARNING: Memory usage exceeded 500MB limit!")
        ...
        if all_efficient and all_stable:
            print("  🎉 All tests passed! Directory scanning is memory efficient.")
        else:
            print("  ⚠️  Some tests failed. Memory optimization may be needed.")
