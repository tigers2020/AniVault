...
### 코드 구조 정책
- **공용 상수/타입/에러:** 소유 계층(CLI/GUI/domain/infrastructure)에 두고, 앱 전역 공용만 **common**(whitelist)에 둡니다. [구조 단순화](docs/architecture/usecase-migration/structure-simplification/README.md) 참조.
