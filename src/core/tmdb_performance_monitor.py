...
from .tmdb_client_pool import TMDBClientPool, ThreadLocalTMDBClient
    ...
    def monitor_operation(self, operation_name: str = "tmdb_operation"):
        ...
        try:
            ...
            if self._current_metrics:
                ...
                logger.debug(f"Operation '{operation_name}' completed in {self._current_metrics.total_time:.3f}s")
    ...
    def get_metrics_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "client_reuse_rate": (
                ...
                if (total_clients_created + total_clients_reused) > 0 else 0.0
            ),
...
class TMDBClientPoolMonitor:
        ...
        return {
            ...
            "efficiency_metrics": {
                ...
                "client_reuse_effectiveness": (
                    current_stats.get("pool_hits", 0) / 
                    current_stats.get("total_requests", 1)
                ),
            },
    ...
    def _generate_recommendations(self, stats: Dict[str, Any], health: Dict[str, Any]) -> List[str]:
        ...
        if utilization_rate > 0.9:
            recommendations.append(
                "High pool utilization detected. Consider increasing pool size."
            )
        elif utilization_rate < 0.3:
            recommendations.append(
                "Low pool utilization detected. Consider reducing pool size."
            )
...
def benchmark_tmdb_approaches(
    ...
    memory_improvement = (traditional["memory_usage"] - optimized["memory_usage"]) / traditional["memory_usage"] * 100
...
_performance_monitor: Optional[TMDBPerformanceMonitor] = None
