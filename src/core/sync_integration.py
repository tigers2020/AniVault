...
from .sync_scheduler import SyncScheduler, SyncJob, SyncJobResult, SyncTrigger
from .sync_config import (
    get_global_config_manager, 
    create_quick_sync_setup,
    SyncSchedulerConfig
)
...
class SyncIntegrationManager:
    ...
    def initialize(
        ...
        scheduler_config: Optional[SyncSchedulerConfig] = None
    ) -> None:
    ...
    def start_scheduler(self, check_interval: Optional[int] = None) -> None:
...
_global_sync_integration: Optional[SyncIntegrationManager] = None
...
def create_sync_callback(
    ...
    custom_handler: Optional[Callable[[SyncJobResult], None]] = None
