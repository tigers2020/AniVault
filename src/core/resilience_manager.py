...
from .database_health import DatabaseHealthChecker, HealthStatus, create_database_health_checker, set_global_health_checker
    ...
    def _attempt_recovery(self) -> bool:
        ...
        with self._lock:
            ...
            if (self._last_recovery_attempt and 
                current_time - self._last_recovery_attempt < self.recovery_check_interval):
            ...
            try:
                ...
                if self.health_checker:
                    ...
                    if health_status == HealthStatus.HEALTHY:
                        ...
                        logger.warning(f"Recovery attempt failed, health status: {health_status.value}")
    ...
    def _start_recovery_monitoring(self) -> None:
        ...
        with self._lock:
            ...
            self._recovery_thread = threading.Thread(
                ...
                name="ResilienceRecoveryMonitor",
                daemon=True
            )
