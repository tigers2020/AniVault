...
class CacheSimilarityKeys:
    ...
    def store_similarity_keys(self, key: str, value: ParsedAnimeInfo | TMDBAnime) -> None:
    ...
    def update_similarity_keys(self, key: str, value: ParsedAnimeInfo | TMDBAnime) -> None:
    ...
    def get_similarity_stats(self) -> dict[str, Any]:
        ...
        return {
            ...
            "average_similarity_keys_per_entry": (
                total_similarity_keys / total_keys if total_keys > 0 else 0
            ),
            "similarity_key_coverage": (
                len(self._similarity_keys) / total_keys if total_keys > 0 else 0
            ),
        }

    def _generate_similarity_keys(self, value: ParsedAnimeInfo | TMDBAnime) -> set[str]:
    ...
    def get_similarity_key_coverage(self) -> dict[str, float]:
        ...
        coverage["season_episode_coverage"] = (
            season_episode_keys / total_keys if total_keys > 0 else 0.0
        )
