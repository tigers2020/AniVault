...
class CompressionManager:
    ...
    def __init__(self, 
                 ...
                 max_compression_ratio: float = 0.8):  # Only compress if we save at least 20%
    ...
    def should_compress(self, data: Union[str, bytes, Dict[str, Any]], 
    ...
    def compress_data(self, data: Union[str, bytes, Dict[str, Any]]) -> tuple[bytes, CompressionStats]:
    ...
    def decompress_data(self, compressed_bytes: bytes, 
                       expected_type: str = 'str') -> tuple[Union[str, bytes, Dict[str, Any]], CompressionStats]:
    ...
    def compress_for_storage(self, data: Union[str, Dict[str, Any]]) -> str:
    ...
    def decompress_from_storage(self, stored_data: str, 
                               expected_type: str = 'dict') -> Union[str, Dict[str, Any]]:
    ...
    def _estimate_size(self, data: Union[str, bytes, Dict[str, Any]]) -> int:
