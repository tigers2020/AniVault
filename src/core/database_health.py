...
class DatabaseHealthChecker:
    ...
    def get_last_failure_time(self) -> Optional[float]:
    ...
    def remove_status_change_callback(self, callback: Callable[[HealthStatus, HealthStatus], None]) -> None:
...
def get_database_health_checker() -> Optional[DatabaseHealthChecker]:
