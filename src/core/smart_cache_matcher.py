...
class QueryNormalizer:
    ...
    def __init__(self, remove_stop_words: bool = True, expand_abbreviations: bool = True) -> None:
...
class SimilarityDetector:
    ...
    def __init__(self, fuzzy_threshold: float = 60.0, phonetic_threshold: float = 0.8) -> None:
...
class SmartCacheMatcher:
    ...
    def should_use_smart_matching(self, query: str) -> bool:
        ...
        has_variation_patterns = any(
            pattern in query.lower() for pattern in ["(", ")", ".", "_", "-", "the ", "a ", "an "]
        )
