...
class BackupManager:
    ...
    def create_backup(self, suffix: str | None = None, max_backups: int = 10) -> Path:
        ...
        if not self.db_path.exists():
            msg = f"Database file not found: {self.db_path}"  # pylint: disable=line-too-long
        ...
        try:
            ...
            if backup_shm_path.exists():
                ...
                try:
                    ...
                    logger.warning("Failed to restore SHM file (may be in use): %s", e)
    ...
    def list_backups(self) -> list[Path]:
        ...
        backups = sorted(
            ...
            reverse=True,
        )  # CorePatterns.BACKUP_FILE_PATTERN
        return backups
