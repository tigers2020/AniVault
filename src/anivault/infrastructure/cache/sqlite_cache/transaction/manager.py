...
# Self is available in typing_extensions and Python 3.11+
# Use typing_extensions for compatibility
try:
    from typing_extensions import Self
except ImportError:
    # Fallback: use string annotation for older Python versions
    if TYPE_CHECKING:
        from typing import Self  # type: ignore[attr-defined, no-redef]
    else:
        # Runtime fallback: Self will be resolved from string annotation
        pass
