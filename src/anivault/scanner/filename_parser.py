        ...
        for pattern in self.patterns:
            try:
                ...
                if result is not None:
                    ...
                    episode_number = result.get("episode", "").strip()
                    episode_title = result.get("episode_title", "").strip()
                    season = result.get("season")
                    year = result.get("year")
                    release_group = result.get("release_group", "").strip()
                    quality = result.get("quality", "").strip()
                    ...
                    if parsed_info.anime_title and (
                        parsed_info.episode_number or parsed_info.episode_title
                    ):
