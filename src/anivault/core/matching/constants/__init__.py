"""
Matching Engine Constants (S5: extracted from shared.constants.matching).
"""

from typing import ClassVar

# FallbackStrategy.TIMEOUT = 5.0 seconds
_BASE_SECOND = 1.0
...
# Scoring label constants (used by CandidateScoringService)
SCORE_HIGH = "high"
SCORE_MEDIUM = "medium"
