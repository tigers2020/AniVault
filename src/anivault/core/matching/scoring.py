...
def calculate_confidence_score(normalized_query: Dict[str, Any], tmdb_result: Dict[str, Any]) -> float:
    ...
    try:
        ...
        year_score = _calculate_year_score(normalized_query.get("year"), tmdb_result.get("release_date"))
