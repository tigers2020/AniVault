...
from anivault.presentation.cli.common.context import CliContext, LogLevel, set_cli_context
from anivault.presentation.cli.common.error_handler import handle_cli_error
from anivault.shared.types.cli import CLIDirectoryPath as DirectoryPath
from anivault.presentation.cli.common.options import (
    benchmark_option,
    json_output_option,
    log_level_option,
    verbose_option,
...
from anivault.presentation.cli.common.validation import create_validator
from anivault.presentation.cli.log_handler import log_command
from anivault.presentation.cli.match_handler import match_command
from anivault.presentation.cli.organize_handler import organize_command
from anivault.presentation.cli.run_handler import run_command
from anivault.presentation.cli.scan_handler import scan_command
from anivault.presentation.cli.verify_handler import verify_command
...
def get_container() -> Container:
    ...
    if _container is None:
        ...
        _container.wire(
            modules=[
                "anivault.presentation.cli.scan_handler",
                "anivault.presentation.cli.match_handler",
                "anivault.presentation.cli.organize_handler",
            ]
        )
