...
from anivault.presentation.gui.components.layout.main_content import MainContentComponent
from anivault.presentation.gui.components.layout.overlay_layer import OverlayLayerComponent
from anivault.presentation.gui.controllers import MatchController, OrganizeController, ScanController
from anivault.presentation.gui.dialogs.settings_dialog import SettingsDialog
from anivault.presentation.gui.dialogs.tmdb_manual_search_dialog import TmdbManualSearchDialog
from anivault.presentation.gui.flows.organize_execution import run_organize_execute_flow
from anivault.presentation.gui.models import OperationError, OperationProgress, ViewKind, format_progress_message
...
class MainWindow(QMainWindow):
    ...
    def get_current_scan_results(self) -> list[FileMetadata]:
        ...
        return self._subtitle_scan_results if self.is_subtitles_view() else self._scan_results
    ...
    def get_active_match_target_value(self) -> str:
        ...
        return ViewKind.SUBTITLES.value if self.is_subtitles_view() else ViewKind.VIDEOS.value
