...
def scan(
    ...
    try:
        ...
        # Output results
        if json_output:
            _output_json_event("scan", "complete", {
...
def _parse_files_with_anitopy(files: List[Dict[str, Any]], json_output: bool) -> List[Dict[str, Any]]:
...
def _save_scan_results(results: Dict[str, Any], output_path: Path, stats_only: bool) -> None:
