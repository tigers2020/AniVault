...
from anivault.services.cache.sqlite_cache.backup import BackupManager
...
class SQLiteCacheDB:
    ...
    def __init__(
        ...
        self.backup_manager = BackupManager(self.db_path, backup_dir)
    ...
    def get_cache_info(self) -> dict[str, Any]:
        ...
        now = datetime.now(timezone.utc)  # pylint: disable=import-outside-toplevel
    ...
    def create_backup(self, suffix: str | None = None) -> Path:
        ...
        """
        return self.backup_manager.create_backup(suffix=suffix)

    def restore_backup(self, backup_path: Path, create_backup: bool = True) -> None:
        ...
        """
        self.backup_manager.restore_backup(backup_path, create_backup=create_backup)
    ...
    def transaction(self) -> Any:
        ...
        Example:
            ...
            ...     cache.set_cache("key1", {"data": "value1"}, "search")
            ...     cache.set_cache("key2", {"data": "value2"}, "search")
        """
        # pylint: disable=import-outside-toplevel
        # Lazy import to avoid circular dependency
        from anivault.services.cache.sqlite_cache.transaction import TransactionManager
        ...
        return TransactionManager(self.conn)
